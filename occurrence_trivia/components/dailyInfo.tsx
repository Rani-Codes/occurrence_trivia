...
interface DailyInfoProps {
    dayChosen: string;
    isHintOpen: boolean; // Control for AlertDialog open state
    setIsHintOpen: (value: boolean) => void; // Function to close the AlertDialog
}
...
const DailyInfo = ({ dayChosen, isHintOpen, setIsHintOpen }: DailyInfoProps) => {
    const { daily } = useDailyChallenge(dayChosen)
    
    return (
        <>
            <AlertDialog open={isHintOpen} onOpenChange={setIsHintOpen}>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        <div className="flex justify-center w-full">
                            <AlertDialogCancel onClick={() => setIsHintOpen(false)}>Close</AlertDialogCancel>
                        </div>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
